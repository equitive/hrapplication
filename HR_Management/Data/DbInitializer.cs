    ...
    public class DbInitializer
    {
        public static async Task Initialize(ApplicationDbContext context, UserManager<ApplicationUser> _userManager)
        {
            ...
            if (!context.Employee.Any())
            {
                ...
                new Employee{empId=3,password="password3",fname="Sabrina",lname="Dia",address="907 Secret Cove Lane Minneapolis, MI 58390", email="sdia@gmail.com", phoneNumber="4567890123", status= "Intern", department="Design", jobTitle=3, vacationDays=0, sickTime=0, startDate="12/25/2015", endDate="", managerID=11, employeeType=0, rank=4, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                new Employee{empId=4,password="password4",fname="Liz",lname="Woods",address="234 Grand Dr Annex, FL 98793", email="lwoods@gmail.com", phoneNumber="5678901234", status= "Full-Time", department="Human Resources", jobTitle=4, vacationDays=40, sickTime=5, startDate="10/31/2000", endDate="", managerID=14, employeeType=4, rank=5, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                ...
                new Employee{empId=6,password="password6",fname="Desiree",lname="Strong",address="456 Kinsey Road Austin, Texas 87897", email="dstrong@gmail.com", phoneNumber="7890123456", status= "Full-Time", department="Human Resources", jobTitle=6, vacationDays=20, sickTime=10, startDate="02/03/2004", endDate="", managerID=4, employeeType=2, rank=2, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                new Employee{empId=7,password="password7",fname="Ekira",lname="Johnson",address="345 Waterfront Circle Portland, OR", email="ejohnson@gmail.com", phoneNumber="8901234567", status= "Intern", department="Human Resources", jobTitle=7, vacationDays=6, sickTime=4, startDate="01/01/2016", endDate="", managerID=4, employeeType=2, rank=8, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                new Employee{empId=8,password="password8",fname="Andrew",lname="Matthew",address="234 Yellowbrick Road Las Vegas, NV 83487", email="amatthew@gmail.com", phoneNumber="9012345678", status= "Full-Time", department="Design", jobTitle=8, vacationDays=8, sickTime=3, startDate="07/30/2015", endDate="", managerID=11, employeeType=0, rank=6, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                new Employee{empId=9,password="password9",fname="Richard",lname="Wei",address="473 Winterfold Lane Orlando, FL 73749", email="rwei@gmail.com", phoneNumber="0123456789", status= "Full-Time", department="Engineering", jobTitle=9, vacationDays=30, sickTime=20, startDate="05/15/2007", endDate="", managerID=14, employeeType=1, rank=9, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                new Employee{empId=10,password="password10",fname="Fanny",lname="Lopez",address="907 Queensridge Circle Tutledge, AL 83747", email="flopez@gmail.com", phoneNumber="1122334455", status= "Full-Time", department="Engineering", jobTitle=10, vacationDays=10, sickTime=4, startDate="09/09/2009", endDate="", managerID=9, employeeType=0, rank=7, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
                new Employee{empId=11,password="password11",fname="Kelsey",lname="Gonzales",address="837 Petrawood Island Waikiki, HI", email="kgonzales@gmail.com", phoneNumber="2233445566", status= "Full-Time", department="Design", jobTitle=11, vacationDays=1, sickTime=9, startDate="04/13/2000", endDate="", managerID=14, employeeType=1, rank=10, ImageData=imageData, isTerminated=false, terminationReason="", twoWeeksNotice=""},
            ...
            if (!context.PositionInfo.Any())
            {
                ...
                {
                new PositionInfo{status=true, managerID=1, empId=0, jobTitle="Sales Representative II", jobDescription="Sell retail products, goods and services to customers. Sales representatives work with customers to find what they want, create solutions and ensure a smooth sales process.", salary=40000},
                new PositionInfo{status=true, managerID=14, empId=1, jobTitle="Sales Manager", jobDescription="Manage all the sales representatives", salary=100000},
                ...
                new PositionInfo{status=true, managerID=11, empId=3, jobTitle="Design Intern", jobDescription="Learn fron the full time design employees and produce a project by the end of the internship.", salary=20000},
                new PositionInfo{status=true, managerID=14, empId=4, jobTitle="Human Resource Manager", jobDescription="Lead an organization's HR programs and policies as they apply to employee relations, compensation, benefits, safety, performance and staffing levels.", salary=90000},
                new PositionInfo{status=true, managerID=14, empId=5, jobTitle="Quality Assurance Manager", jobDescription="Determine, negotiate and agree on in-house quality procedures, standards and specifications. assessing customer requirements and ensuring that these are met.", salary=95000},
                new PositionInfo{status=true, managerID=4, empId=6, jobTitle="Human Resources Representative", jobDescription="Recruit, screen, interview and place workers. Handle employee relations, payroll and benefits and training.", salary=44000},
                new PositionInfo{status=true, managerID=4, empId=7, jobTitle="Human Resources Intern", jobDescription="Learn fron the full time human resources employees and present a process they improved by the end of the internship.", salary=10000},
                new PositionInfo{status=true, managerID=11, empId=8, jobTitle="Design II", jobDescription="Create visual concepts, by hand or using computer software, to communicate ideas that inspire, inform, or captivate consumers. They develop the overall layout and production design for advertisements, brochures, magazines, and corporate reports.", salary=60000},
                new PositionInfo{status=true, managerID=14, empId=9, jobTitle="Engineering Manager", jobDescription="Confer with management, production, and marketing staff to discuss project specifications and procedures. Coordinate and direct projects, making detailed plans to accomplish goals and directing the integration of technical activities.", salary=150000},
                new PositionInfo{status=true, managerID=9, empId=10, jobTitle="Engineering II", jobDescription="Work in a variety of fields to analyze, develop and evaluate large-scale, complex systems. This can mean and improve and maintaining current systems or creating brand new projects. Engineers will design and draft blueprints, visit systems in the field and manage projects.", salary=100000},
                new PositionInfo{status=true, managerID=14, empId=11, jobTitle="Design Manager", jobDescription="Manage design or graphics teams and departments. Be extremely innovative, artistic and creative. Collaborate on projects with their colleagues, delegate tasks and check for quality and consistency.", salary=80000},
                new PositionInfo{status=true, managerID=1, empId=12, jobTitle="Sales Representative I", jobDescription="Sell retail products, goods and services to customers. Sales representatives work with customers to find what they want, create solutions and ensure a smooth sales process.", salary=35000},
                new PositionInfo{status=true, managerID=5, empId=13, jobTitle="Quality Assurance I", jobDescription="Develop test plans, test cases and test scripts for projects, among other assigned duties.", salary=70000},
                new PositionInfo{status=true, managerID=99, empId=14, jobTitle="CEO", jobDescription="The Boss.", salary=500000},
                };
